    ...
    <div className="bg-white border rounded-lg h-fit w-[24.6875rem] p-6">
      ...
      <form className="mt-6">
        ...
        <div className="flex justify-between pt-8">
          ...
          <div className="w-[10.4375rem]">
            <button className="py-[0.625rem] px-[1.125rem] border border-solid border-schoolinka-grey-500 rounded-lg font-semibold w-full text-sm text-white bg-schoolinka-primary">Add</button>
          </div>
        </div>
      </form>
    </div>
